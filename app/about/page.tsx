...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mt-40 grid max-w-5xl grid-cols-1 gap-16 border-t border-line pt-8 md:mt-48 md:grid-cols-10 md:gap-x-16 md:border-t-0 md:pt-0">
